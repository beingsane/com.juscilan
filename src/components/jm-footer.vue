...
<footer id="qq" class="page-footer teal">
    ...
    <div>
        <div class="center"><a class="white-text" ng-click="myData.corpo(item, $event)" ng-href="/##corposup">Topo</a></div>
    </div>
    <div class="footer-copyright">
        <div class="container">
            <p class="center header col s12 light">Versão 2.0.3.7 - <span>{{visitors.visitors}}</span> </p>
        </div>
